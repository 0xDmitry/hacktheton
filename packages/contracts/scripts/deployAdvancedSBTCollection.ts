...
export async function run(provider: NetworkProvider) {
  const rewardSBTCollection = provider.open(
    await RewardSBTCollection.fromInit(
      Address.parse("0QC8rz-GAgIMM5dsZwy7xC1Nrf_WxdriXutUD06w21k_7qbq"),
      {
        ...
        flag: 1n,
        content:
          "ipfs://bafybeicra4duvotmwuok4b3eulsquin6rlw75wojkpwkzhxfwlglzvk7qu/advanced-sbt-collection.json",
      },
      "ipfs://bafybeicra4duvotmwuok4b3eulsquin6rlw75wojkpwkzhxfwlglzvk7qu/advanced-sbt-item",
  ...
  console.log("advanced SBT collection address: ", rewardSBTCollection.address)
}
